<form name="enterForm" action="enter.php"  method="POST" onsubmit="return validate()">
	<table>
		...
		?>
			...
			<td>
				<input type="text" size="20" maxlength="20" name="login" placeholder="<?=change_language($lang,'Login')?>" />
			</td>
			<td>
				<input type="password" size="20" maxlength="20" name="password" placeholder="<?=change_language($lang,'Password')?>" />
			</td>
			<td>
